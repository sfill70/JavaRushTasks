...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            User sidirov= new User();
            sidirov.setFirstName("Sidorov");
            sidirov.setLastName("Sidor");
            sidirov.setBirthDate(new Date(1988, 10, 24));
            sidirov.setMale(true);
            sidirov.setCountry( User.Country.RUSSIA);
            javaRush.users.add(sidirov);
            System.out.println(sidirov.getCountry()+" -"+sidirov.getBirthDate().getTime());
        ...
        public void save(OutputStream outputStream) throws Exception {
           ...
           writer.println(users.size());
            for (User us:users) {
                ...
                writer.println(us.getCountry().getDisplayedName());
            }
            writer.flush();
