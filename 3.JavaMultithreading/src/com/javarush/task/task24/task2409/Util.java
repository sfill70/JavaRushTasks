    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans {
           ...
           public abstract String getTM();
            ...
            @Override
            //getClass().getSimpleName()- и так проходит
            // getTM() - Если поставить этот метод будет название компании, то же проходит.
        ...
        class Levis extends AbstractJeans {
            ...
            public String getTM(){return "Levi's";}
        }
        class Denim extends AbstractJeans {
            ...
            public String getTM(){return "Denim";}
        }
