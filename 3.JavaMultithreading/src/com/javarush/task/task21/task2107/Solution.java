...
public class Solution implements Cloneable {
    ...
    protected Solution clone() throws CloneNotSupportedException {
        Solution solution=new Solution();            // ТАК МНЕ КАЖЕТСЯ ПРАВИЛЬНЕЕ
      //  Solution solution=(Solution)super.clone();     //ТАК ТО ЖЕ РАБОТАЕТ
        solution.users = new LinkedHashMap<String, User>();
