...
/**
 * Created by Sfill on 05.07.2017.
 */
public class MyThread extends Thread {
    ...
    private void initialize() {
        ...
        if (getThreadGroup() != null) {
            if (newPriority > Thread.currentThread().getThreadGroup().getMaxPriority()) {
                newPriority = Thread.currentThread().getThreadGroup().getMaxPriority();
            }
        }
